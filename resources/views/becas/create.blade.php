...
@section('title', 'Crear Beca | ' . Config::get('adminlte.title'))

@section('content_header')
    <h2>Crear Nueva Beca</h2>
@stop
...
@section('content')
    <div class="card">
        ...
        <form action="{{ route('becas.create') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nombre_beca') is-invalid @enderror" 
                                   id="nombre_beca" name="nombre_beca" value="{{ old('nombre_beca') }}" required>
                            @error('nombre_beca')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('monto_creditos') is-invalid @enderror" 
                                   id="monto_creditos" name="monto_creditos" value="{{ old('monto_creditos') }}" 
                                   min="0" required>
