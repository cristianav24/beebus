...
@section('title', 'Analitica | ' . Config::get('adminlte.title'))
    ...
    <div class="card-body">
        ...
        <div id="date_filter" class="form-inline">
            <Form action="" method="get" class="form-inline col-sm-12" autocomplete="off">
                ...
                <button type="submit" class="btn btn-primary mb-2"><i class="fa fa-filter"></i> Filtro</button>
            </form>
        </div>
        <hr>
        <!-- Filtering -->
        ...
        <div class="table-responsive datatables-margin-t45">
          <div class="alert alert-info" role="alert">
              Analitica solo muestra datos de "Usuarios que llegan tarde", "horas extra" y "salida anticipada".
          </div>
          <hr>
