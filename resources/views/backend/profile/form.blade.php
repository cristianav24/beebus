        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10 col-content">
                    ...
                    <small class="form-text text-muted">
                        <i class="fa fa-question-circle" aria-hidden="true"></i> tu nombre.
                    </small>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10 col-content">
                    ...
                    <small class="form-text text-muted">
                        <i class="fa fa-question-circle" aria-hidden="true"></i> email, para acceder al panel.
                    </small>
                </div>
            </div>
            ...
            <div id="form-image" class="form-group row">
                ...
                <div class="col-sm-10 col-content">
                    ...
                    <span
                        class="image-upload-label"><i class="fa fa-question-circle" aria-hidden="true"></i> cargar imagen (Tamaño recomendado: 160px × 160px, max 5MB)</span>
