    ...
    function searchStudents(searchTerm) {
        ...
        fetch('{{ route("parent.search-students") }}?search=' + encodeURIComponent(searchTerm))
            ...
            .catch(error => {
                ...
                alert('Error al buscar estudiantes. Por favor, intenta nuevamente.');
            });
    }
    ...
    document.getElementById('submit-requests').addEventListener('click', function() {
        ...
        .then(data => {
            if (data.success) {
                ...
                location.reload(); // Refresh to show pending requests
            } else {
                alert('Error al enviar las solicitudes. Por favor, intenta nuevamente.');
            }
        })
        .catch(error => {
            console.error('Error:', error);
