...
@section('body')
    <div class="wrapper">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        ...
                        @php($getImage = App\Models\Base\User::find(Auth::user()->id))
                        @php($userName = $getImage->name)
                        @php($image = asset('uploads/'.$getImage->image))
        ...
        <footer class="main-footer">
            <strong>Copyright © {{ date("Y") }} <a href="">BeeBus</a>.</strong>
            All rights reserved.
