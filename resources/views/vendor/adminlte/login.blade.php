        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="mt-3 text-center">
                    <a href="{{ route('third-party.search') }}" class="btn btn-success btn-lg mb-2" style="width: 100%; max-width: 400px;">
                        <i class="fas fa-credit-card mr-2"></i>
                        Recargar Créditos a un Estudiante
                    </a>
                </div>
                <div class="mt-2 text-center">
                    <a href="{{ url('https://greenland.ga/privacy_policies.html') }}" class="btn btn-warning text-dark">Recopilamos Datos?</a>
                </div>
@stop
