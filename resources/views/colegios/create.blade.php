...
@section('title', 'Crear Colegio | ' . Config::get('adminlte.title'))
...
@section('content')
    <div class="card">
        ...
        <form action="{{ route('colegios.create') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('codigo_institucional') is-invalid @enderror" 
                                   id="codigo_institucional" name="codigo_institucional" value="{{ old('codigo_institucional') }}">
