...
class AnalyticController extends Controller
{
    ...
    public function index(Datatables $datatables, Request $request)
    {
        ...
        $columns = [
            ...
            'date'=> ['title' => 'Fecha'],
            'in_time'=> ['title' => 'Ingreso'],
            'out_time'=> ['title' => 'Salida'],
            'work_hour'=> ['title' => 'Permanencia'],
            'over_time'=> ['title' => 'Anticipaciom'],
            'late_time'=> ['title' => 'Tardia'],
            'early_out_time'=> ['title' => 'Salida anticipada'],
            'in_location'=> ['title' => 'Lugar ingreso'],
            'out_location'=> ['title' => 'Lugar salida'],
        ];
